...
// PENTING: letakkan file QRIS Anda di folder assets project, lalu sesuaikan path import di bawah ini.
// Contoh struktur umum: src/assets/qris-payment.jpeg
    ...
    <section id="consult" className="py-20 bg-white overflow-x-hidden">
      <div className="container mx-auto px-4 max-w-full">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white/10 text-white font-bold px-6 py-4 rounded-xl border-2 border-white/30 hover:bg-white/20 hover:border-white/50 transition-all backdrop-blur-sm"
                  >
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100">
                  <span className="text-gray-700 font-medium">Senin - Sabtu</span>
        ...
        <div className="lg:hidden space-y-6">
          ...
          >
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-9 h-9 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl flex items-center justify-center">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100">
                  <span className="text-gray-600 font-medium">Senin - Sabtu</span>
                  <span className="font-bold text-green-600 flex items-center gap-2">
                    Buka jam 08.00
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center p-4 bg-gradient-to-r from-red-50 to-rose-50 rounded-xl border border-red-100">
                  <span className="text-gray-600 font-medium">Minggu</span>
                  <span className="font-bold text-red-600 flex items-center gap-2">
                    Tutup
                  </span>
                </div>
          ...
          >
            ...
            <div className="space-y-3">
              <a
                href="https://wa.me/6285258463046"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 bg-white text-red-600 font-semibold px-8 py-4 rounded-xl hover:bg-red-50 transition-all transform hover:scale-105 shadow-lg"
              >
              ...
              {/* Tombol Bayar via QRIS - Mobile */}
              <button
                type="button"
                onClick={() => setShowQrisModal(true)}
                className="w-full flex items-center justify-center gap-2 bg-white/10 text-white font-semibold px-8 py-4 rounded-xl border-2 border-white/30 hover:bg-white/20 transition-all"
              >
                <QrCode className="w-6 h-6" strokeWidth={2} />
                Bayar via QRIS
              </button>
      ...
      {showQrisModal && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-3xl shadow-2xl w-full max-w-sm sm:max-w-md max-h-[88vh] overflow-y-auto overscroll-contain flex flex-col"
          >
            {/* Header */}
            <div className="relative bg-gradient-to-br from-red-600 via-red-700 to-red-800 px-6 pt-6 pb-8 flex-shrink-0">
              <button
                type="button"
                onClick={() => setShowQrisModal(false)}
              ...
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 bg-white/15 rounded-xl flex items-center justify-center backdrop-blur-sm flex-shrink-0">
                  <QrCode className="w-6 h-6 text-white" strokeWidth={2} />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-white leading-tight">Pembayaran QRIS</h3>
                  <p className="text-red-100 text-sm">Scan untuk membayar</p>
                </div>
              </div>
            </div>
            ...
            <div className="px-6 pb-6 -mt-4">
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4">
                <div className="rounded-xl overflow-hidden border border-gray-100 flex justify-center bg-gray-50">
                  <img
                    src={qrisImage}
                ...
                <button
                  ...
                  className="mt-4 w-full flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-3 rounded-xl transition-all text-sm"
                >
              ...
              <p className="text-center text-gray-500 text-xs mt-4 leading-relaxed">
                Mendukung semua aplikasi e-wallet & mobile banking berlogo QRIS
                <br />
                (GoPay, OVO, Dana, ShopeePay, BCA, BRI, Mandiri, dll)
              </p>
            </div>
          </motion.div>
        </div>
      ...
      {showQrisFullscreen && (
        <div
          ...
          onClick={() => setShowQrisFullscreen(false)}
        >
          <button
            type="button"
            onClick={() => setShowQrisFullscreen(false)}
            className="absolute top-5 right-5 text-white hover:bg-white/10 p-2.5 rounded-full transition-all"
          >
            <X className="w-7 h-7" />
          </button>
          <motion.img
