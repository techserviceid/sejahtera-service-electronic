...
const Hero = () => {
  ...
  // Tanggal & jam real-time (diperbarui tiap detik)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-0 lg:gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="flex items-center gap-2 mb-3 sm:mb-4 whitespace-nowrap"
            >
              ...
              <div className="flex items-center gap-1.5">
                <span
                  className="text-sm sm:text-base font-semibold text-white inline-block text-left w-[66px] sm:w-[80px]"
                >
                  {formattedTime}
                </span>
